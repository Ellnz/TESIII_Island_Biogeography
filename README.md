...
- Olearia angulata -> stoneflower leaf
- Entelea arborescens -> gold kanet flower


## Credits:
- Pherim: Caveplant (perm pending)
- Otis_Geo: Mournhold Plants, Land textures (perm pending)
- Tyddy: land textures (perm pending)
- Melchoir Dahrk: Emperor Parasol (perm pending)
- Vurt: BC tree trunk texture

Unknown textures:
all the tx_bc and tree bark textures are from an unknown source, having been on my harddrive for years. Will be phased out later.
